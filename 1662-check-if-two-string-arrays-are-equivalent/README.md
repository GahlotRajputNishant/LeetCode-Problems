...
🟢 **Easy** &nbsp;|&nbsp; [View on LeetCode](https://leetcode.com/problems/check-if-two-string-arrays-are-equivalent/)
...
**My Solution:** [1662-Check-If-Two-String-Arrays-are-Equivalent.java](./1662-Check-If-Two-String-Arrays-are-Equivalent.java)
